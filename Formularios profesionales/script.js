 ...
 * VERSIÓN CORREGIDA para redirección a gracias.html
 * 
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  form.addEventListener('submit', e => {
    ...
    // --- LÓGICA CORREGIDA: Si es válido, permitir envío real ---
    if (valid) {
      // OCULTAR mensaje de éxito local
      success.style.display = 'none';
      
      // CREAR un nuevo formulario temporal para el envío
      const tempForm = document.createElement('form');
      tempForm.action = form.action;
      tempForm.method = form.method;
      tempForm.style.display = 'none';
      
      // COPIAR todos los datos del formulario original
